...
Code.initLanguage = function() {
  ...
  document.getElementById('tab_blocks').textContent = 'blocks';
  document.getElementById('linkButton').title = 'link';
  document.getElementById('runButton').title = 'run';
  document.getElementById('trashButton').title = 'trash';
};
